...
import { FiBook, FiFileText, FiUsers, FiSettings, FiTrendingUp, FiPlus, FiEdit3, FiTrash2, FiEye, FiBarChart, FiCalendar, FiCoffee, FiShoppingBag, FiActivity } from 'react-icons/fi';
...
export default function AdminDashboard() {
  ...
  const quickActions = [
    { title: 'Ny kurs', icon: FiBook, href: '/admin/courses/new', color: 'from-blue-400 to-blue-600' },
    { title: 'Nytt blogginlägg', icon: FiFileText, href: '/admin/blog/new', color: 'from-green-400 to-green-600' },
    { title: 'Nytt recept', icon: FiCoffee, href: '/admin/recipes/new', color: 'from-orange-400 to-orange-600' },
    { title: 'Hantera beställningar', icon: FiShoppingBag, href: '/admin/orders', color: 'from-purple-400 to-purple-600' }
  ];
              ...
              {quickActions.map((action, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <FiPlus className="w-5 h-5 ml-auto text-gray-400 group-hover:text-gray-600" />
                  </Link>
                </motion.div>
              ))}
            </div>
              ...
              {stats.recentActivity.map((activity, index) => (
                ...
                >
                  <div className={`p-2 rounded-lg mr-4 ${
                    ...
                    {activity.type === 'course' && <FiBook className="w-5 h-5" />}
                    {activity.type === 'blog' && <FiFileText className="w-5 h-5" />}
                    {activity.type === 'recipe' && <FiCoffee className="w-5 h-5" />}
