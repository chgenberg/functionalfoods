...
export default function Checkout() {
  ...
  const [pendingRecoveredCoupon, setPendingRecoveredCoupon] = useState<
    string | null
  >(null);
    ...
    const recoverCart = async () => {
      try {
        const res = await fetch(
          `/api/checkout/recover-cart?orderId=${encodeURIComponent(recoverOrderId)}`,
        );
    ...
    try {
      ...
      try {
        trackInitiateCheckout({
          items: campaignItems.map((i) => ({
            id: i.id,
            name: i.name,
            price: i.price,
            quantity: i.quantity,
          })),
          value: campaignItems.reduce(
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        ...
        <p className="text-text-secondary">
          {t("checkout.loading", "Laddar checkout...")}
        </p>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-[#F7F5F0] flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-6">
          ...
          <h2 className="text-2xl font-light mb-2">
            {t("checkout.empty", "Din varukorg är tom")}
          </h2>
          <p className="text-gray-600 mb-8">
            {t("checkout.emptyDesc", "Du har inga produkter i din varukorg.")}
          </p>
          <Link
            href="/utbildning"
            className="inline-flex items-center gap-2 bg-[#014421] text-white px-6 py-3 rounded-full hover:bg-[#1a5530] transition-colors"
          >
            {t("checkout.exploreCourses", "Utforska våra program")}
    ...
    <main className="min-h-screen bg-[#F7F5F0] py-6 sm:py-12 pb-32 lg:pb-12">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 sm:mb-12 text-center">
          <Link
            href="/cart"
            className="inline-flex items-center text-sm sm:text-base text-gray-600 hover:text-gray-800 mb-4 sm:mb-6 transition-colors"
          >
          ...
          <h1 className="text-2xl sm:text-3xl font-light text-gray-900">
            {t("checkout.title", "Slutför ditt köp")}
          </h1>
        </div>
              ...
              {guestMode ? (
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <label className="flex items-start sm:items-center gap-2 sm:gap-3 text-xs sm:text-sm text-gray-600 cursor-pointer">
                    ...
                    <span>
                      {t(
                        ...
                        "Skapa ett konto för enklare köp nästa gång",
                      )}
                    </span>
                  </label>
                  ...
                  <p className="text-xs sm:text-sm text-gray-500">
                    ...
                    <Link
                      href="/login"
                      className="text-[#014421] hover:underline ml-1"
                    >
                  ...
                  <div className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-green-50 rounded-lg sm:rounded-xl">
                    ...
                    <div className="min-w-0">
                      <p className="text-xs sm:text-sm text-gray-600">
                        {t("checkout.loggedInAs", "Inloggad som")}
                      </p>
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-8 shadow-sm">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 flex-1">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs sm:text-sm text-gray-500">
                          Betala med Visa, Mastercard, Apple Pay eller Google
                          Pay
                        </p>
                      </div>
                    </div>
              ...
              <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-200">
                ...
                <p className="text-[10px] sm:text-xs text-gray-500 mt-2 sm:mt-3">
                  Apple Pay och Google Pay visas automatiskt vid betalning om de
                  är tillgängliga på din enhet.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm overflow-hidden lg:sticky lg:top-8">
              <div className="p-4 sm:p-6 border-b border-gray-100">
                <h2 className="text-base sm:text-lg font-medium">
                  {t("checkout.orderSummary", "Din beställning")}
                </h2>
              </div>
                ...
                {items.map((item) => (
                  <div key={item.id} className="flex gap-3 sm:gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs sm:text-sm text-gray-500">
                        {item.type === "course" ? "Kurs" : "Bok"} •{" "}
                        {item.quantity} st
                      </p>
                      <p className="font-medium text-sm sm:text-base text-gray-900 mt-0.5 sm:mt-1">
                        {Math.round(
                ...
                <div className="pt-3 sm:pt-4 border-t border-gray-100 space-y-1.5 sm:space-y-2">
                  <div className="flex justify-between text-xs sm:text-sm">
                    ...
                    <span className="text-gray-900 whitespace-nowrap">
                      {subtotalExVat.toLocaleString()} kr
                    </span>
                  </div>
                  {hasDiscount && (
                    <div className="flex justify-between text-xs sm:text-sm">
