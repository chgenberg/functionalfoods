...
export default function ChatBot() {
      ...
      setMessages([
        {
          ...
          text: t(
            "chat.welcome",
            "Hej! Jag är Functional Foods AI‑assistent, fråga mig vad du vill om Functional Foods, hälsa och recept...",
          ),
          sender: "bot",
          timestamp: new Date(),
        },
      ...
      (errorMessage) => {
        const errorMsg: Message = {
          ...
          text:
            ...
            t(
              "chat.error",
              "Ursäkta, något gick fel. Försök igen senare eller kontakta oss på hej@functionalfoods.se",
            ),
          sender: "bot",
          timestamp: new Date(),
        };
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-4 sm:bottom-6 sm:right-6 sm:inset-auto z-50 sm:w-96 sm:h-[600px] bg-white rounded-2xl shadow-2xl flex flex-col transform transition-all duration-300 ${isOpen ? "scale-100 opacity-100" : "scale-0 opacity-0"}`}
      >
        {/* Header */}
        <div className="bg-primary text-white p-4 rounded-t-2xl flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative">
              <Image
                src="/Ulrika_portratt/Ulrika3.jpg?v=1"
                alt="Ulrika AI:sson"
                width={40}
                height={40}
            ...
            <div>
              ...
              <p className="text-xs opacity-90">
                {t("chat.ready", "Alltid redo att hjälpa")}
              </p>
            </div>
          </div>
          <button
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          {messages.map((message) => (
            ...
            >
              <div
                className={`max-w-[80%] rounded-2xl px-4 py-2 ${message.sender === "user" ? "bg-primary text-white rounded-br-none" : "bg-gray-100 text-gray-800 rounded-bl-none"}`}
              >
                {message.sender === "bot" ? (
                  <div
        ...
        {messages.length === 1 && (
          <div className="px-4 pb-2">
            <p className="text-xs text-gray-500 mb-2">
              {t("chat.examples", "Vanliga frågor:")}
            </p>
        ...
        <div className="p-4 border-t">
          <div className="flex gap-2">
            ...
            <button
              ...
              className={`p-2 rounded-full transition-all ${inputValue.trim() && !isLoading ? "bg-primary text-white hover:bg-primary" : "bg-gray-200 text-gray-400 cursor-not-allowed"}`}
            >
