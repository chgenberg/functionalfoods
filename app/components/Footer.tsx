...
export default function Footer() {
  ...
  const footerLinks = {
    utbildning: [
      ...
      {
        label: t("footer.links.functionalBasics", "Functional Basics"),
        href: "/utbildning/functional-basics",
      },
      {
        label: t("footer.links.functionalFlow", "Functional Gut Health/Flow"),
    ...
    juridisk: [
      {
        label: t("footer.links.terms", "Användarvillkor"),
        href: "/anvandarvillkor",
      },
      {
        label: t("footer.links.personal", "Personuppgifter"),
        href: "/personuppgifter",
      },
      {
        label: t("footer.links.privacy", "Integritetspolicy"),
        href: "/integritetspolicy",
      },
      {
        label: t("footer.links.cookie", "Cookie-policy"),
        href: "/cookie-policy",
      },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/80 mb-6 leading-relaxed">
              {t(
                "footer.description",
                "Din personliga guide till hälsosam mat och välmående genom vetenskapligt grundade functional foods.",
              )}
            </p>
            <div className="flex space-x-4">
              ...
              <a
                href="https://www.tiktok.com/@functionalfoods.se"
                className="text-white/60 hover:text-white transition-colors"
              >
                <FaTiktok className="w-6 h-6" />
              </a>
              <a
                href="https://facebook.com/functionalfoods"
                className="text-white/60 hover:text-white transition-colors"
              >
          ...
          <div>
            <h3 className="font-bold text-lg mb-4">
              {t("footer.sections.knowledge", "Kunskapsbank")}
            </h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="font-bold text-lg mb-4">
              {t("footer.sections.legal", "Juridiskt")}
            </h3>
            <ul className="space-y-2">
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/60 text-sm mb-4 md:mb-0">
            ...
            {t(
              "footer.copyright",
              "Functional Foods. Alla rättigheter förbehållna.",
            )}
          </p>
