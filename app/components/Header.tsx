          ...
          <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-scale-in">
            ...
            <div className="px-6 pb-6">
              ...
              <div className="flex gap-3 mb-6">
                <button className="flex-1 bg-white hover:bg-gray-50 border border-gray-300 hover:border-gray-400 text-gray-700 py-2.5 px-4 rounded-xl font-medium transition-all duration-200 hover:scale-[1.02] hover:shadow-md flex items-center justify-center gap-2 group">
