        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="space-y-2 text-sm text-gray-700 leading-relaxed">
              <p>
                <strong>Denna kurs ersätter inte medicinsk rådgivning.</strong> Innehållet är utformat för 
                allmän utbildning och ska inte användas för att diagnostisera eller behandla hälsoproblem.
              </p>
              <p>
                <strong>Konsultera alltid din läkare</strong> innan du gör större förändringar i din kost eller 
