              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold">
                    {isProvaPaVecka
                      ? "Prova på-veckan Guide"
                      : "Dashboard Guide"}
                  </h2>
                  <p className="text-white/90">
                    {isProvaPaVecka
                      ? "Din introduktion till Functional Foods"
                      : "Lär dig navigera ditt program effektivt"}
                  </p>
                </div>
              </div>
              <button
                ...
                <>
                  ...
                  <div className="mb-6 p-5 bg-gradient-to-r from-[#93C560]/20 to-[#014421]/10 rounded-2xl border border-[#014421]/10">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-bold text-[#014421] text-lg mb-1">
                          Välkommen till din prova på-vecka!
                        </h3>
                        <p className="text-sm text-gray-700">
                          Under den här veckan får du smaka på Functional Foods
                          med utvalda recept och kunskapsdokument. Målet är att
                          du ska uppleva hur mervärdesmat kan påverka din energi
                          och ditt välmående.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-start gap-3 p-4 bg-[#F7F1E8] rounded-xl border border-[#014421]/10">
                          ...
                          <div>
                            <div className="font-semibold text-[#014421]">
                              Översikt
                            </div>
                            <div className="text-sm text-gray-600">
                              Se välkomstvideo och en introduktion till veckan
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3 p-4 bg-[#F3EFE3] rounded-xl border border-[#014421]/10">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">
                              7 dagar med måltidsplan, recept och
                              kunskapsdokument
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3 p-4 bg-[#F7F1E8] rounded-xl border border-[#014421]/10">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">
                              Summering och nästa steg i din hälsoresa
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-3 p-3 bg-white rounded-xl border border-[#014421]/10">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">
                              Komplett lista för hela veckan
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 p-3 bg-white rounded-xl border border-[#014421]/10">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">
                              Lär dig grunderna i Functional Foods
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 p-3 bg-white rounded-xl border border-[#014421]/10">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">
                              Ställ frågor och få stöd från Team Ulrika
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="mt-6 p-6 bg-white border-2 border-[#014421]/20 rounded-2xl">
                    ...
                    <div className="space-y-3 text-sm text-gray-700">
                      <p className="flex items-start gap-2">
                        ...
                        <span>
                          <strong>Handla i förväg</strong> – använd inköpslistan
                          för att ha allt hemma innan veckan startar
                        </span>
                      </p>
                      <p className="flex items-start gap-2">
                        <span className="text-[#014421] font-bold">•</span>
                        <span>
                          <strong>Klicka på måltider</strong> för att se
                          fullständiga recept med ingredienser och instruktioner
                        </span>
                      </p>
                      <p className="flex items-start gap-2">
                        <span className="text-[#014421] font-bold">•</span>
                        <span>
                          <strong>Ladda ner PDF</strong> av recept du gillar för
                      ...
                      <p className="flex items-start gap-2">
                        <span className="text-[#014421] font-bold">•</span>
                        <span>
                          <strong>Läs kunskapsdokumenten</strong> för att förstå
                          varför maten gör skillnad
                        </span>
                      </p>
                      <p className="flex items-start gap-2">
                        <span className="text-[#014421] font-bold">•</span>
                        <span>
                          <strong>Gå med i Facebook-gruppen</strong> för daglig
                      ...
                      <p className="flex items-start gap-2">
                        <span className="text-[#014421] font-bold">•</span>
                        <span>
                          <strong>Njut av resan!</strong> Detta är en
                          introduktion – känn ingen press
                        </span>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 p-5 bg-gradient-to-r from-[#FF7E70]/10 to-[#FF7E70]/5 rounded-2xl border border-[#FF7E70]/20">
                    ...
                    <p className="text-sm text-gray-700">
                      Gillade du upplevelsen? Våra kompletta kurser (6 veckor)
                      ger dig ännu fler recept, djupare kunskap och personlig
                      coachning för att verkligen förändra din hälsa.
                    </p>
                  </div>
                </>
              ) : (
                      ...
                      <div className="space-y-3">
                        <div className="flex items-start gap-3 p-4 bg-[#F7F1E8] rounded-xl border border-[#014421]/10">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">
                              Se din framsteg, kursöversikt och välkomstvideo
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3 p-4 bg-[#F3EFE3] rounded-xl border border-[#014421]/10">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">
                              Varje vecka innehåller måltidsplan, recept och
                              läsning
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3 p-4 bg-[#F7F1E8] rounded-xl border border-[#014421]/10">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">
                              Slutför kursen och få ditt certifikat
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-3 p-3 bg-white rounded-xl border border-[#014421]/10">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">
                              Ladda ner smarta listor för varje vecka
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 p-3 bg-white rounded-xl border border-[#014421]/10">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">
                              Fördjupa din kunskap med dokument
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="mt-8 p-6 bg-gradient-to-r from-[#F7F1E8] to-[#F3EFE3] rounded-2xl border border-[#014421]/10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-medium text-sm text-[#014421]">
                            Mörkgrön
                          </div>
                  ...
                  <div className="mt-6 p-6 bg-white border-2 border-[#014421]/20 rounded-2xl">
                    ...
                    <div className="space-y-3 text-sm text-gray-700">
                      <p className="flex items-start gap-2">
                        <span className="text-[#014421] font-bold">•</span>
                        <span>
                          <strong>Navigera enkelt</strong> med menyn som alltid
                          ligger överst på sidan
                        </span>
                      </p>
                      <p className="flex items-start gap-2">
                        <span className="text-[#014421] font-bold">•</span>
                        <span>
                          <strong>Klicka på måltider</strong> för att se recept
                          och näringsvärden
                        </span>
                      </p>
                      <p className="flex items-start gap-2">
                        <span className="text-[#014421] font-bold">•</span>
                        <span>
                          <strong>Ladda ner PDF</strong> av dina favoritrecept
                          från dag-vyn
                        </span>
                      </p>
                      <p className="flex items-start gap-2">
                        <span className="text-[#014421] font-bold">•</span>
                        <span>
                          <strong>Läs veckans dokument</strong> som finns direkt
                          under välkomstmeddelandet
                        </span>
                      </p>
                      <p className="flex items-start gap-2">
                        <span className="text-[#014421] font-bold">•</span>
                        <span>
                          <strong>Delta i Community</strong> för att ställa
                          frågor och dela tips
                        </span>
                      </p>
                      <p className="flex items-start gap-2">
                        <span className="text-[#014421] font-bold">•</span>
                        <span>
                          <strong>Uppdatera profilen</strong> under
                          Inställningar
                        </span>
                      </p>
                    </div>
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-600">
                ...
                <a
                  ...
                  className="text-[#014421] font-semibold hover:text-[#116530] transition-colors"
                >
