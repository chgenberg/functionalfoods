      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-gray-600">
            Dela erfarenheter och få stöd från andra programdeltagare
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          >
            ...
            <div className="text-3xl font-bold text-[#014421]">
              {stats.totalMembers}
            </div>
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    <div
                      className={`p-3 rounded-lg ${getCategoryStyle(category.color)}`}
                    >
                      <Icon className="w-6 h-6" />
                    </div>
                    <span className="text-sm text-gray-500">
                      {categoryThreads.length} inlägg
                    </span>
                  </div>
                  ...
                  {category.latestPost && (
                    <div className="text-xs text-gray-500">
                      <p className="truncate">
                        Senaste: {category.latestPost.title}
                      </p>
                    ...
                    <div className="flex items-start gap-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span
                            className={`px-2 py-1 text-xs font-semibold rounded-full ${getCategoryStyle(
