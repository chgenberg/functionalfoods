      ...
      try {
        ...
        if (!res.ok) {
          if (res.status === 401) {
            ...
            setError("Du har inte tillgång till detta program");
            return;
          }
          ...
          <div className="lg:col-span-3">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
              ...
              <div className="flex justify-between text-sm text-gray-600">
                <span>
                  {completedLessons.length} av {totalLessons} lektioner
                  slutförda
                </span>
                <span>
                  Vecka {currentWeek} av {course.weeks.length}
                </span>
              </div>
            </div>
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-gray-600">
                      Vecka {currentWeek} • Lektion {playingVideo}
                    </p>
                  </div>
                  <button
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {course.name === "Functional Gut Health/Flow"
                        ? "Avancerad"
                        : "Grundläggande"}
                    </span>
                  </div>
