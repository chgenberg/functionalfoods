...
Under de fem veckor som passerat har du ätit socker- och glutenfritt. Recepten är baserade på en lågkolhydratkost och det gör att ditt blodsocker hålls jämnt och stabilt. Du har också varierat ditt kaloriintag över veckans dagar och ibland ätit mindre och ibland ätit mer. Det här för att främja din förbränning. Vad kommer du att plocka med dig från kursen? Kanske göra en veckoplanering så du vet exakt vad du ska äta och vad du ska köpa hem. Göra flera portioner så att du vissa dagar kan äta rester och ha färdiga matlådor hemma. Just det här hjälper dig dagar då tiden är knapp och när det annars hade varit lätt att ta till något som inte är lika hälsosamt som dina egna hemlagade matlådor. Lycka till med sista veckan!`
  }
};
