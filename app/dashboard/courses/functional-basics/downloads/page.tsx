  ...
  const downloads: Download[] = [
    {
      ...
      description:
        "Komplett guide över de 10 viktigaste livsmedelskategorierna",
      category: "guide",
      size: "2.4 MB",
      icon: GiFruitBowl,
      popular: true,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-lg text-gray-600">
            Ladda ner guider, recept och arbetsmaterial
          </p>
        </motion.div>
                  ...
                  <div
                    className={`w-12 h-12 rounded-full flex items-center justify-center ${
                      download.category === "guide"
                        ...
                        : download.category === "recipe"
                          ? "bg-background-secondary text-primary"
                          : download.category === "shopping"
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                Tips för nedladdningar
              </h3>
              <p className="text-gray-600">
                Alla dokument är i PDF-format och kan skrivas ut eller sparas på
                din enhet. Vi rekommenderar att du skapar en mapp för
                programmaterialet så du enkelt hittar allt du behöver.
              </p>
            </div>
          </div>
        </motion.div>
