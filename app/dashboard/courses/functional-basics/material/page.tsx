...
export default function KnowledgeMaterialPage() {
  ...
  const modules: KnowledgeModule[] = [
    {
      ...
      description:
        "Lär dig grunderna om mervärdesmat och dess 10 livsmedelskategorier",
      icon: GiFruitBowl,
      color: "#014421",
      readTime: "6 min",
  ...
  const filteredModules = modules.filter((module) => {
    ...
    const matchesCategory =
      selectedCategory === "alla" || module.category === selectedCategory;
        ...
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto opacity-90">
              Fördjupa din kunskap om Functional Foods med våra expertskrivna
              artiklar
            </p>
