...
import { User, Mail, Lock, Save, Check, AlertCircle, ShoppingCart, Download } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow p-6 md:p-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <h2 className="text-lg font-semibold mb-3 flex items-center gap-2"><User /> Profil</h2>
          ...
          <div className="border-t pt-4">
            <h2 className="text-lg font-semibold mb-3 flex items-center gap-2"><Lock /> Byt lösenord</h2>
          ...
          {message && (
            <div className={`p-3 rounded ${message.type==='success' ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'}`}>
              {message.type==='success' ? <Check className="inline mr-2"/> : <AlertCircle className="inline mr-2"/>}{message.text}
            </div>
          )}

          <div className="flex items-center justify-between gap-3 pt-2">
            <div className="flex gap-3">
              <Link href="/utbildning" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-800"><ShoppingCart/> Köp fler kurser</Link>
              {/* Kvittolista */}
            </div>
      ...
      <div className="bg-white rounded-xl shadow p-6 md:p-8 mt-6">
        <h2 className="text-lg font-semibold mb-3 flex items-center gap-2"><Download/> Kvitton</h2>
