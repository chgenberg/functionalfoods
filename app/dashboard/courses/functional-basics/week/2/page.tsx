                ...
                {dayMeals.breakfast && (
                  <div className="bg-orange-50 rounded-lg p-4">
                    ...
                    {dayMeals.breakfast.slug && (
                      <Link href={`/kunskapsbank/recept/${dayMeals.breakfast.slug}`} className="text-sm text-orange-600 hover:underline mt-1 inline-block">Se recept →</Link>
                    )}
                  </div>
                )}
                {dayMeals.lunch && (
                  <div className="bg-green-50 rounded-lg p-4">
                    ...
                    {dayMeals.lunch.slug && !dayMeals.lunch.name.includes('rester') && (
                      <Link href={`/kunskapsbank/recept/${dayMeals.lunch.slug}`} className="text-sm text-green-600 hover:underline mt-1 inline-block">Se recept →</Link>
                    )}
                  </div>
                )}
                {dayMeals.dinner && (
                  <div className="bg-purple-50 rounded-lg p-4">
                    ...
                    {dayMeals.dinner.slug && (
                      <Link href={`/kunskapsbank/recept/${dayMeals.dinner.slug}`} className="text-sm text-purple-600 hover:underline mt-1 inline-block">Se recept →</Link>
                    )}
                  </div>
                )}
              </div>
