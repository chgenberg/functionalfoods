        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-7 gap-4">
            {getDaysForWeek(6).map((day) => (
              <div key={day.day} className={`relative p-6 rounded-2xl transition-all ${day.current ? 'bg-gradient-to-br from-[#FFB5A7] to-[#FCD5CE] shadow-xl scale-105' : day.completed ? 'bg-white hover:shadow-lg' : day.locked ? 'bg-gray-50 opacity-60' : 'bg-white hover:shadow-lg'}`} onClick={() => (window.location.href = `/dashboard/courses/functional-basics/week/6/day/${day.day}`)}>
