  ...
  const achievements = [
    {
      icon: Battery,
      title: "Energistarten",
      description: "Genomförde din första vecka med stabilt blodsocker",
    },
    {
      icon: Coffee,
      title: "Sockerfri",
      description: "Minskade ditt sockerberoende och sötsug",
    },
    {
      icon: Zap,
      title: "Stabil energi",
      description: "Höll energin uppe en hel vecka utan dippar",
    },
    {
      icon: Moon,
      title: "Bättre sömn",
      description: "Förbättrade din sömnkvalitet genom balanserat blodsocker",
    },
    {
      icon: Trophy,
      title: "Kursmästare",
      description: "Slutförde hela 6-veckors programmet",
    },
  ];
    ...
    <main className="min-h-screen bg-gradient-to-br from-[#F7F1E8] via-[#F3EFE3] to-[#EDE5D8]">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-700 mb-8 leading-relaxed max-w-3xl mx-auto">
              Du har slutfört din 6-veckors resa mot stabilt blodsocker och jämn
              energi. Det är dags att fira dina framsteg!
            </p>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
              <p className="text-xl mb-6">
                Nu är du i mål och har under 6 veckor gett din kropp
                mervärdesmat och lärt dig laga goda functional foods-rätter som
                stödjer din hälsa. Du har gjort stora framsteg och förändrat din
                hälsa på många sätt, särskilt när det gäller att hantera
                blodsockernivåerna.
              </p>

              <p className="mb-6">
                Efter att ha följt veckornas kostscheman och inköpslistor, är
                det dags att ta nästa steg och börja planera din kost på egen
                hand. Du har fått kunskap om hur Functional Foods fungerar och
                vilka råvaror som bör ingå dagligen i din kost för att hålla
                blodsockret stabilt och främja en god hälsa.
              </p>

              <p className="mb-6">
                Jag hoppas också att du känner glädje i köket och tycker att det
                är roligt att laga mat på ett hälsosamt sätt som verkligen
                stödjer din hälsa.
              </p>

              <div className="bg-[#F3EFE3] rounded-2xl p-6 my-8 border-l-4 border-[#93C560]">
                <p className="text-[#014421] font-medium text-lg">
                  <Lightbulb className="w-5 h-5 inline" /> Det viktigaste för
                  att fortsätta med Functional Foods som livsstil är de positiva
                  resultaten du upplever. Ta en stund och reflektera över de
                  förändringar du känner både kroppsligt och mentalt. Du mår med
                  stor sannolikhet bättre och det är något du verkligen vill
                  fortsätta att må – för både din hälsa och ditt välmående
                  framöver!
                </p>
              </div>
            </div>
        ...
        <section className="mb-16">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Du har uppnått dessa milstolpar under din resa
            </p>
          </motion.div>
        ...
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold mb-6 text-center">
              Reflektera över dina förändringar
            </h2>
        ...
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-[#014421] mb-8 text-center">
              Fortsätt din hälsoresa
            </h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">
                  Utforska fler recept och kunskapsartiklar i vår kunskapsbank
                </p>
                <Link
                  href="/kunskapsbank"
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">
                  Fortsätt utvecklas med nya hälsomål och utmaningar
                </p>
                <Link
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">
                  Inspirera andra genom att dela din framgångshistoria
                </p>
                <Link
        ...
        <section className="text-center">
          ...
          >
            <h2 className="text-3xl font-bold mb-4">
              Tack för att du genomförde Functional Energy!
            </h2>
            <p className="text-xl mb-8 opacity-90">
              Du har nu verktygen för ett liv med stabilt blodsocker och jämn
              energi
            </p>
