...
const downloads = [
  {
    ...
    description: "Hela programmet i PDF-format med alla veckor och recept",
    size: "15.2 MB",
    type: "PDF",
    icon: Book,
  },
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-sm text-blue-800">
              <strong>Tips:</strong> Ladda ner allt material för att ha tillgång
              till programmet även offline. Perfekt för resor eller när du inte
