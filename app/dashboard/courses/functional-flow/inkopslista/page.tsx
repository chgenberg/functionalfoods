...
function ShoppingListContent() {
  ...
  const generateShoppingList = async () => {
    ...
    try {
      const response = await fetch(`/api/shopping-list/flow/${week}`);
      if (response.ok) {
        ...
        const mockIngredients: Ingredient[] = [
          ...
          { name: 'Yoghurt', amount: '500', unit: 'g', category: 'Mejeri', checked: false },
          
          // Kött & Fisk
          { name: 'Lax', amount: '600', unit: 'g', category: 'Kött & Fisk', checked: false },
          { name: 'Kyckling', amount: '800', unit: 'g', category: 'Kött & Fisk', checked: false },
          { name: 'Torsk', amount: '500', unit: 'g', category: 'Kött & Fisk', checked: false },
          ...
          { name: 'Broccoli', amount: '1', unit: 'huvud', category: 'Frukt & Grönt', checked: false },
          { name: 'Paprika', amount: '3', unit: 'st', category: 'Frukt & Grönt', checked: false },
          
          // Skafferi
          { name: 'Quinoa', amount: '400', unit: 'g', category: 'Skafferi', checked: false },
          { name: 'Olivolja', amount: '1', unit: 'flaska', category: 'Skafferi', checked: false },
          { name: 'Havregryn', amount: '500', unit: 'g', category: 'Skafferi', checked: false },
          
          // Kryddor & Såser
          { name: 'Basilika', amount: '1', unit: 'kruka', category: 'Kryddor & Såser', checked: false },
          { name: 'Vitlök', amount: '1', unit: 'klyfta', category: 'Kryddor & Såser', checked: false }
        ];
  ...
  const handleExport = () => {
    ...
    a.href = url;
    a.download = `inköpslista-flow-vecka-${week}.txt`;
    a.click();
    ...
    <div className="min-h-screen bg-[#F8F5F0]">
      ...
      <div className="bg-white shadow-lg print:hidden">
        <div className="max-w-7xl mx-auto px-2 md:px-4 py-4">
          <CourseNavigation courseType="flow" currentWeek={week} />
        </div>
      </div>
      ...
      <div className="bg-white border-b print:hidden">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              <Link
                href={`/dashboard/courses/functional-flow/week/${week}`}
