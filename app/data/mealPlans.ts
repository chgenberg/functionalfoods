...
export const mealPlans: Record<string, WeekMealPlan> = { "week1": { "days": { "Måndag": { "breakfast": { "name": "Yoghurt med ketomüsli", "recipeLink": "/kunskapsbank/recept/yoghurt-ketomusli" }, "lunch": { "name": "Tonfisksallad med äpple", "recipeLink": "/kunskapsbank/recept/tonfisksallad-med-apple" }, "dinner": { "name": "Squashspagetti med köttfärssås", "recipeLink": "/kunskapsbank/recept/squashspagetti-med-kottfarssas" }, "snack": { "name": "Ketomüsli", "recipeLink": "/kunskapsbank/recept/ketomusli" }
      ...
      }, "Torsdag": { "breakfast": { "name": "Omelett med tomat", "recipeLink": "/kunskapsbank/recept/omelett-tomat" }, "lunch": { "name": "Het ratatouille rester", "recipeLink": "/kunskapsbank/recept/het-ratatouille" }, "dinner": { "name": "Pokébowl med kyckling rester", "recipeLink": "/kunskapsbank/recept/poke-bowl-kyckling" }, "snack": { "name": "Havrefrallor med morötter och aprikoser", "recipeLink": "/kunskapsbank/recept/havrefrallor-med-morotter-och-aprikoser" }
      }, "Fredag": { "breakfast": { "name": "Havrefralla med morötter och torkade aprikoser", "recipeLink": "/kunskapsbank/recept/havrefralla-med-morotter-och-torkade-aprikoser" }, "lunch": { "name": "Köttfärsbiffar med stekt blomkål rester", "recipeLink": "/kunskapsbank/recept/kottfarsbiffar-stekt-blomkal" }, "dinner": { "name": "Kycklinggryta med bakad spetskål", "recipeLink": "/kunskapsbank/recept/kycklinggryta-med-bakad-spetskal" }
      }, "Lördag": { "breakfast": { "name": "Tropisk smoothiebowl", "recipeLink": "/kunskapsbank/recept/smoothie-smoothiebowl" }, "lunch": { "name": "Kycklinggryta med bakad spetskål rester", "recipeLink": "/kunskapsbank/recept/kycklinggryta-med-bakad-spetskal" }, "dinner": { "name": "Laxburgare med krämig grönsaksröra", "recipeLink": "/kunskapsbank/recept/laxburgare-med-kramig-gronsaksrora" }, "dessert": { "name": "Mangoglass", "recipeLink": "/kunskapsbank/recept/mangoglass" }
    ...
    }, "title": "Vecka 3: Synkroniserad från DOCX" }, "week4": { "days": { "Måndag": { "breakfast": { "name": "Omelett med bär", "recipeLink": "/kunskapsbank/recept/ugnsomelett-med-keso-och-bar" }, "lunch": { "name": "Lax med waldorfsallad rester", "recipeLink": "/kunskapsbank/recept/lax-med-waldorfsallad" }, "dinner": { "name": "Grekiska köttbullar i tomatsås med rostad sötpotatis", "recipeLink": "/kunskapsbank/recept/grekiska-kottbullar-i-tomatsas" }
      ...
      }, "Onsdag": { "breakfast": { "name": "Fruktsmoothie", "recipeLink": "/kunskapsbank/recept/smoothie-2" }, "lunch": { "name": "Kycklinggryta med röda linser rester", "recipeLink": "/kunskapsbank/recept/kycklinggryta-fran-medelhavet" }, "dinner": { "name": "Laxsallad med vindruvor", "recipeLink": "/kunskapsbank/recept/laxsallad-med-druvor" }
      }, "Torsdag": { "breakfast": { "name": "Fruktsmoothie rester", "recipeLink": "/kunskapsbank/recept/smoothie-2" }, "lunch": { "name": "Laxsallad med vindruvor rester", "recipeLink": "/kunskapsbank/recept/laxsallad-med-druvor" }, "dinner": { "name": "Asiatiska köttbullar med nudelsallad rester från fysen", "recipeLink": "/kunskapsbank/recept/asiatiska-kottbullar-med-nudelsallad" }
      ...
      }, "Söndag": { "breakfast": { "name": "Mangosmoothie med spenat rester", "recipeLink": "/kunskapsbank/recept/smoothie-spenat" }, "lunch": { "name": "Kycklingjärpar med linssallad rester", "recipeLink": "/kunskapsbank/recept/kycklingjarpar-med-linssallad" }, "dinner": { "name": "Laxfilé med ratatouille", "recipeLink": "/kunskapsbank/recept/het-ratatouille" }
      }
    }, "title": "Vecka 5: Synkroniserad från DOCX" }, "week6": { "days": { "Måndag": { "breakfast": { "name": "1 havrefrallor med morötter och aprikoser + valfritt pålägg", "recipeLink": "/kunskapsbank/recept/havrefrallor-morotter-aprikoser" }, "lunch": { "name": "Laxfilé med ratatouille rester", "recipeLink": "/kunskapsbank/recept/het-ratatouille" }, "dinner": { "name": "Grönsakswok med kyckling", "recipeLink": "/kunskapsbank/recept/poke-bowl-kyckling" }
...
export const flowMealPlans: Record<string, WeekMealPlan> = { "week1": { "days": { "Måndag": { "breakfast": { "name": "Färskostmacka med tomat", "recipeLink": "/kunskapsbank/recept/farskostmacka-med-tomat" }, "lunch": { "name": "Linssoppa från medelhavet", "recipeLink": "/kunskapsbank/recept/linssoppa-medelhavet-soppa" }, "dinner": { "name": "Kycklingburgare med papayasallad", "recipeLink": "/kunskapsbank/recept/kycklingburgare-papayasallad-sallad" }, "snack": { "name": "Morot- och kesolimpa", "recipeLink": "/kunskapsbank/recept/morot-och-kesolimpa" }
      ...
      }, "Tisdag": { "breakfast": { "name": "Kokta ägg med kaviar", "recipeLink": "/kunskapsbank/recept/kokt-agg-kaviar" }, "lunch": { "name": "Nötgryta med rotfrukter rester från frysen", "recipeLink": "/kunskapsbank/recept/notgryta-med-rotfrukter" }, "dinner": { "name": "Stekt torsk med bearnaisesås och haricot verts", "recipeLink": "/kunskapsbank/recept/stekt-torsk-med-bearnaisesas-och-haricots-verts" }
      }, "Onsdag": { "breakfast": { "name": "Yoghurt med bovetegranola och bär", "recipeLink": "/kunskapsbank/recept/yoghurt-bovetegranola-bar" }, "lunch": { "name": "Stekt torsk med bearnaisesås och haricot verts rester", "recipeLink": "/kunskapsbank/recept/stekt-torsk-med-bearnaisesas-och-haricots-verts" }, "dinner": { "name": "Kycklingfärsbiffar med vitlöksost", "recipeLink": "/kunskapsbank/recept/kycklingfarstimbaler-med-farskost-och-sweet-chili" }
