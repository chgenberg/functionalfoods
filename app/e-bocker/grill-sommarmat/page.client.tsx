...
const DEFAULT_CONTENT = {
  ...
  subtitle: "För vardag, fest och grillkvällar",
  description:
  ...
  shortDescription:
    "Här hittar du recept som passar lika bra till en enkel middag på altanen som till sommarens större grillfester och bufféer. ",
...
export default function GrillSommarmatPage() {
  ...
  const ebook = {
    ...
    quantity: 1,
    type: "book" as const,
    image: content.image || "/grill-sommarmat-omslag.png",
  };
  ...
  useEffect(() => {
    const fetchContent = async () => {
      try {
        const response = await fetch("/api/pages/grill-sommarmat");
        if (response.ok) {
          ...
          >
            <div className="relative group">
              ...
              <div className="relative">
                ...
                >
                  <Image
                    src={content.image || "/grill-sommarmat-omslag.png"}
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-gray-300 text-sm">
                Inspiration till hälsosamma sommarrätter där färska råvaror, 
                grönsaker och proteinrika alternativ står i fokus.
              </p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-gray-300 text-sm">
                Recept som passar lika bra till en enkel middag på altanen 
                som till sommarens större grillfester och bufféer.
              </p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-gray-300 text-sm">
                Du får recept på kött, kyckling, fisk, skaldjur, vegetariska 
                alternativ och tillbehör som gör måltiden komplett.
              </p>
            </div>
          </div>
        </motion.div>
