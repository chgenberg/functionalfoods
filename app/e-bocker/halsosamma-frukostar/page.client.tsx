...
const DEFAULT_CONTENT = {
  ...
  subtitle: "Näringsrika recept för en hälsosam start på dagen",
  description:
  ...
  price: "99 kr",
  features: [
    "Kalla frukostfavoriter med yoghurt och keso",
    "Bröd och gröter som ger långvarig energi",
    "Proteinrika ägg- och omeletträtter",
    "Plättar och pannkakor med naturliga råvaror",
    "Smoothies, smoothiebowls och hemgjord granola",
...
export default function HalsosammaFrukostarPage() {
  ...
  const ebook = {
    ...
    quantity: 1,
    type: "book" as const,
    image: content.image || "/halsosamma-frukostar-omslag.png",
  };
  ...
  useEffect(() => {
    const fetchContent = async () => {
      try {
        const response = await fetch("/api/pages/halsosamma-frukostar");
        if (response.ok) {
          ...
          >
            <div className="relative group">
              ...
              <div className="relative">
                ...
                >
                  <Image
                    src={content.image || "/halsosamma-frukostar-omslag.png"}
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-gray-300 text-sm">
                Inspirerande frukostrecept – från smoothies och chiapudding till
                omeletter, gröter och hembakat.
              </p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-gray-300 text-sm">
                Med 65 recept som innehåller naturliga och proteinrika råvaror
                och passar både till vardag och helg.
              </p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-gray-300 text-sm">
                Recept skapade med fokus på balans, mättnad och energi för att
                ge kroppen en riktigt bra start på dagen.
              </p>
            </div>
          </div>
        </motion.div>
