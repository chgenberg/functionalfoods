...
export default function JuiceGlowPage() {
  ...
  const ebook = {
    ...
    price: 121.7, // 129 kr inkl 6% moms = 121.70 kr exkl moms (129 / 1.06)
    quantity: 1,
    type: "book" as const,
    image: content.image || "/juice-glow-omslag.png",
  };
  ...
  useEffect(() => {
    const fetchContent = async () => {
      try {
        const response = await fetch("/api/pages/juice-glow");
        if (response.ok) {
          ...
          >
            <div className="relative group">
              ...
              <div className="relative">
                ...
                >
                  <Image
                    src={content.image || "/juice-glow-omslag.png"}
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              ...
              <h3 className="text-white font-semibold mb-2">
                Färgstarka juicerecept
              </h3>
              <p className="text-gray-300 text-sm">
                Smakrika kombinationer med gröna blad, grönsaker, frukt, citrus,
                örter, ingefära och kryddor som gör det enkelt att variera dina
                juicer.
              </p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-gray-300 text-sm">
                41 recept på juicer, smoothies och varma kvällsdrycker,
                tillsammans med en komplett guide för en 3–5 dagars juicekur.
              </p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-gray-300 text-sm">
                Du får tips om juicing, shots och smoothies – plus inspiration
                till hur färska och växtbaserade råvaror kan bli en naturlig del
                av din vardag.
              </p>
            </div>
          </div>
