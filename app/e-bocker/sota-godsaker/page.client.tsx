...
const DEFAULT_CONTENT = {
  title: "Söta Godsaker",
  subtitle: "Sockerfria & glutenfria bakverk",
  description:
  ...
  shortDescription:
    "I boken hittar du både klassiska favoriter och nya favoriter att upptäcka, perfekta för både vardag, fika och fest. ",
...
export default function SotaGodsakerPage() {
  ...
  useEffect(() => {
    const fetchContent = async () => {
      try {
        const response = await fetch("/api/pages/sota-godsaker");
        if (response.ok) {
          ...
          >
            <div className="relative group">
              ...
              <div className="relative">
                ...
                >
                  <Image
                    src={content.image || "/sota-godsaker-omslag.png"}
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-gray-300 text-sm">
                Näringsrika, mättande och riktigt goda bakverk som är enkla att
                lyckas med hemma.
              </p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-gray-300 text-sm">
                Inspirerande recept för fika och dessert – lika perfekta till
                vardag som fest, och som du kommer vilja baka om och om igen.
              </p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-gray-300 text-sm">
                Recept skapade med fokus på balans och näring – oavsett om du
                äter glutenfritt för hälsan, magen eller för att få jämnare
                energi över dagen.
              </p>
            </div>
          </div>
