...
export default function LaxFetaRecipe() {
  ...
  const baseIngredients = [
    ...
    { name: "örtagårdskrydda", amount: 1, unit: "krm" },
    { name: "sötpotatis", amount: 1, unit: "st" },
    { name: "palsternacka", amount: 1, unit: "st" },
    { name: "brysselkål", amount: 250, unit: "g" },
    { name: "olivolja", amount: 2, unit: "tsk" },
    { name: "färsk timjan", amount: 2, unit: "msk" }
  ];
  ...
  const steps = [
    ...
    "Skala och skär sötpotatis och palsternacka i mindre bitar och lägg i en skål.",
    "Dela brysselkålen och blanda ner med olivolja och kryddor.",
    "Lägg blandningen runt laxen och gratinera i 20 minuter.",
    "Strö på lite färsk timjan."
  ];
  ...
  const scaledIngredients = baseIngredients.map(ingredient => ({
    ...ingredient,
    amount: Math.round((ingredient.amount * servings) / 4 * 10) / 10
  }));
          ...
          <div className="container-custom">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 uppercase">
                LAX MED FETAOST OCH ROSTADE ROTFRUKTER
              </h1>
              <p className="text-lg text-white/90 mb-6 max-w-2xl">
                En näringsrik och smakrik rätt med omega-3, antioxidanter och fibrer. Perfekt för en balanserad middag!
              </p>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 animate-fade-in" style={{ animationDelay: '0.4s' }}>
                ...
                <div className="mt-8 p-6 bg-blue-50 rounded-xl">
                  ...
                  <ul className="space-y-2 text-sm text-gray-700">
                    <li>• Använd färsk lax för bästa smak och textur</li>
                    <li>• Rosta pumpafröna lätt i torr panna för extra smak</li>
                    <li>• Servera med en fräsch sallad för en komplett måltid</li>
                  </ul>
                </div>
              </div>
            </div>
