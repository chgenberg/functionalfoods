  ...
  const benefits = [
    {
      ...
      description:
        "Rätt kost stödjer kroppens hormonproduktion och hjälper dig återfå balans på cellnivå.",
    ...
    },
    {
      ...
      description:
        "Genom antiinflammatorisk kost och rätt näringsämnen kan symptom minskas betydligt.",
    ...
    },
    {
      ...
      description:
        "Näringsrik mat påverkar hjärnans funktion positivt och ger mer stabil energi.",
      color: "text-blue-600",
    },
    {
      icon: Heart,
      ...
      description:
        "Rätt kost kan minska inflammationer som påverkar hormonbalansen negativt.",
      color: "text-red-600",
    },
    {
      icon: Users,
      ...
      description:
        "Få stöd och vägledning från Functional Foods teamet under hela kursen.",
  ...
  const whatYouGet = [
    {
      ...
      description:
        "Antiinflammatoriska, näringsrika måltider för hormonell balans",
    },
    {
      icon: GiBrain,
    ...
    },
    {
      ...
      description:
        "Lär dig vilka livsmedel som blockerar och rubbar hormonbalansen",
    },
    {
      icon: Play,
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 max-w-7xl mx-auto mb-16">
          ...
          >
            ...
            >
              För dig som vill få koll på dina hormoner! Känner du dig ofta
              trött, nedstämd och att känslorna snurrar runt inombords? Du är
              inte ensam! Ungefär 8 av 10 kvinnor upplever olika typer av
              hormonella besvär vid PMS, i förklimakteriet eller i klimakteriet.
              Men det finns lösningar för att må bättre – med rätt kost och
              coachning kan symptomen minskas!
            </motion.p>
          ...
          {activeTab === "overview" && (
            ...
            >
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl max-w-4xl mx-auto">
                <h2 className="text-2xl md:text-3xl font-light mb-6 text-center">
                  För dig som vill få koll på{" "}
                  <span className="text-accent font-bold">dina hormoner</span>
                </h2>
                <div className="prose prose-lg max-w-none text-text-secondary mb-6 leading-relaxed">
                  <p className="mb-4">
                    Känner du dig ofta trött, nedstämd och att känslorna snurrar
                    runt inombords? Du är inte ensam! Ungefär 8 av 10 kvinnor
                    upplever olika typer av hormonella besvär vid PMS, i
                    förklimakteriet eller i klimakteriet. Men det finns
                    lösningar för att må bättre – med rätt kost och coachning
                    kan symptomen minskas! Ulrika har skapat en unik kurs som
                    inte bara adresserar dina bekymmer, utan också ger dig
                    verktygen för att återta kontrollen över ditt liv och komma
                    i hormonell balans!
                  </p>

                  <h3 className="text-xl font-medium mb-4 mt-6">
                    Förebygga och påverka
                  </h3>
                  <p className="mb-4">
                    Hormonell Balans är nödvändigt för att du ska må bra och
                    kunna förebygga sjukdomar, – speciellt i 35-55 årsåldern, då
                    hormonnivåerna förändras, och du blir mer lättpåverkad av
                    både fel mat och stress. Vi har samlat ett urval av studier
                    och forskning som stödjer innehållet i Ulrikas kurser (du
                    hittar kunskapsbanken i menyn) för dig som vill fördjupa dig
                    mer. Kursen bygger på principerna inom Functional Foods –
                    näring som påverkar kroppens funktioner positivt och hjälper
                    dig återfå balans på cellnivå.
                  </p>

                  <p className="mb-4">
                    Att kosten och kaloriintag är avgörande som flertalet
                    studier visar är ingen nyhet. Vad som däremot är viktigt att
                    lyfta fram är HUR stor påverkan kosten faktiskt har på vår
                    hälsa. Hälsa är ju så mycket mer än vikt och även om kosten
                    absolut är avgörande när man vill göra en viktnedgång så kan
                    den även påverka dig som har värk och inflammationer i
                    kroppen, lider av mag- och tarmproblem, klimakteriebesvär
                    eller andra hormonella problem.
                  </p>

                  <p className="mb-4">
                    Maten du äter påverkar mycket i kroppen, din hormonella
                    produktion, hjärnans funktion, ditt humör och givetvis din
                    hälsa. Om din kost inte innehåller rätt näringsämnen kan din
                    kropp inte producera hormoner på rätt sätt, och inte heller
                    upprätthålla hormonbalansen. Det kommer du märka av genom
                    tex försämrad sömn och irritation. Genom Functional Foods
                    lär du dig hur du med näringsrika råvaror, rätt
                    kombinationer av fett, protein och kolhydrater samt
                    antiinflammatoriska livsmedel kan stödja hormonproduktionen
                    naturligt.
                  </p>

                  <p className="mb-4">
                    Med rätt kost kan du dock påverka din hormonella balans
                    positivt och mildra besvären vid PMS, i förklimakteriet och
                    i klimakteriet.
                  </p>
                </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl max-w-4xl mx-auto">
                ...
                <div className="prose prose-lg max-w-none text-text-secondary mb-6 leading-relaxed">
                  <p className="mb-4">
                    Hormonell Balans innehåller hälsosam mat som bygger på
                    antiinflammatorisk kost där tyngden ligger på mat, som i sin
                    tur stödjer kroppens hormonella balans. Kursen innehåller
                    inget gluten, socker och det är minimalt med
                    komjölksprodukter. Det är en varierad kost med mycket
                    grönsaker, naturligt protein och bra fetter.
                  </p>
                  ...
                  <p className="mb-4 mt-6">
                    I kursen får du lära dig vilken mat som blockerar och rubbar
                    din hormonella balans, så du vet vad du bör undvika. Du får
                    även lära dig mer om hormoner och deras funktioner samt vad
                    de 6 viktigaste faktorerna är för att komma i hormonell
                    balans.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <div className="mt-12 bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl max-w-4xl mx-auto">
                <p className="text-text-secondary leading-relaxed">
                  ...
                  att inkludera dessa näringsrika livsmedel i din kost kan du
                  uppleva förbättringar inom alla dessa områden.
                </p>
              </div>
            </motion.div>
          )}
